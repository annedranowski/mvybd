...
\begin{equation}
    S_{\mu_1,\mu_2} = N_-(\CC[t,t^{-1}, (t-s)^{-1}]) L_{\mu_1,\mu_2}\,. 
\end{equation}
...
\begin{equation}
    ...
    \begin{split}
        ...
        %L\otimes\CC[t^{-1}] 
        L_{\mu_1,\mu_2}\otimes \CC\xt[t-s] 
        &\in \Gr^{\lambda_2} \text{ and } \\
        % L\otimes\CC[(s-t)^{-1}] 
        L_{\mu_1,\mu_2}\otimes \CC\xt &\in \Gr^{\lambda_1}\}\,.
    \end{split}
\end{equation}
% 
...
Let
$\cW_\mu = G_1[t^{-1}]t^\mu $ and $\hat \cW_\mu = G_1[[t^{-1}]] t^\mu$.
...
\begin{lemma}%[Roger's lemma]
    ...
    \begin{equation}
        S_{\mu_1,\mu_2}^s \subset \hat \cW_\mu 
    \end{equation}
    where $\mu = \mu_1 + \mu_2$.
\end{lemma}
