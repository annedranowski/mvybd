...
These different versions of the affine Grassmannian are related as follows.  First there is an isomorphism $ \Gr \cong \Gr_s $ coming from the isomorphism $ \Ks \cong \cK$.
...
\begin{itemize}
    ...
    \item The family $ \overline{\Gr}^{\lambda_1, \lambda_2} \rightarrow \AA$, defined by $ \overline{\Gr}^{\lambda_1, \lambda_2} = \overline{Gr}^{\lambda_1} * \overline{Gr}^{\lambda_2}$.  By construction the fibre of $ \overline{\Gr}^{\lambda_1, \lambda_2} $ over $ s \ne 0 $ is $ \overline{\Gr}^{\lambda_1} \times \overline{\Gr}^{\lambda_2}$.  By Zhu's theorem (\jcom{need ref}), the fibre over $ 0 $ is $ \overline{\Gr}^{\lambda_1 + \lambda_2}$.
\end{itemize}
\begin{itemize}
