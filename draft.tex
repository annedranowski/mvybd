...
\begin{lemma} \label{le:Wmu}
    ...
    \begin{enumerate}
        ...
        \item $ \beta_\mu := \{ [t^k e_i] : 0 \le k < \mu_i, 1 \le i \le m\}$ forms a basis for $ L_0/L$ and for all $ i $, 
...
From this, we can deduce that $ \beta_\mu$ forms a basis for $ L_0/L$.  Hence (ii) implies (iii).  
...
\begin{proof}
Since we already have the isomorphism from Theorem \ref{th:TmuWmu}, it suffices to show that for any $ A \in \TT_\mu$, $$ (A,s) \in \overline{\OO}^{\lambda_1, \lambda_2}_\AA \cap T_\mu \text{ if and only if } (g(A), s) \in \Gr^{\lambda_1, \lambda_2}_\AA \cap \cW_\mu $$
