...
\end{definition}
    ...
    Note, since $ \lambda $ is effective, $ t^\lambda \in \Gr^+ $ and so the spherical Schubert variety $\overline{\Gr}^\lambda $ lies inside the positive part $ \Gr^+$ of the affine Grassmannian. \acom{why and so? cuz orbits are connected?}
    % 
\begin{definition} 
