...
The variety $X(\tau)$ defined by taking the top dimensional component of \acom{todo}
...
\begin{proof}
    ...
    L\cap \CC[t]^i = l. 
    $$
    By definition of $X'\ast_s X''$,  $A\big|_{\CC^{|\mu(i)|}}$ has Jordan type $((\lambda'(i),0),(\lambda''(i),s))$ and lies in $\UU^{\mu'(i),\mu''(i)}_{0,s}$. So, by \Cref{th:OTGrW}, $l\in\Gr_{0,s}^{\lambda'(i),\lambda''(i)}$ which fits the alternate description of $Z(\tau)$.
