...
\begin{proposition}
    The family $\OO^{\lambda_1,\lambda_2}_{0,\AA}$ defined by \Cref{above} has zero fibre $\OO^\lambda$. 
\end{proposition}
...
The case that we are interested in is the case of two eigenvalues: $(z_1,z_2) = (0,s)$. \acom{Does order matter?} 
