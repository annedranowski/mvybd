...
Conversely, given $L\in\mathring Z(\tau')\ast_s \mathring Z(\tau'')$, we can write $ L = g(A)\CC[t]^m$ by  \Cref{th:OGrl}. Then reversing the above logic, we conclude that $ A \in \mathring X(\tau',\tau'')_{0,s}$.
\end{proof}
% 
